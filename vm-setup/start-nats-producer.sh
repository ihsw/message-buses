...
gcloud compute ssh $GCLOUD_AUTH -- "docker run -d -it -e NATS_HOST=$NATS_HOST -e METRICS_HOST=$METRICS_HOST --entrypoint="" ihsw/nats-producer ./bin/run-app nats-producer"
gcloud compute ssh $GCLOUD_AUTH -- "docker run -d -it -e NATS_HOST=$NATS_HOST -e METRICS_HOST=$METRICS_HOST --entrypoint="" ihsw/nats-producer ./bin/run-app nats-producer"
gcloud compute ssh $GCLOUD_AUTH -- "docker run -d -it -e NATS_HOST=$NATS_HOST -e METRICS_HOST=$METRICS_HOST --entrypoint="" ihsw/nats-producer ./bin/run-app nats-producer"
gcloud compute ssh $GCLOUD_AUTH -- "docker run -d -it -e NATS_HOST=$NATS_HOST -e METRICS_HOST=$METRICS_HOST --entrypoint="" ihsw/nats-producer ./bin/run-app nats-producer"
